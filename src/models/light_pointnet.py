...
class BasePointNet(nn.Module):
    ...
    def forward(self, x):
        ...
        x_tnet = torch.cat([x_tnet, x], dim=2)  # concat z and intensity. dims total = 9
...
class ClassificationPointNet(nn.Module):
    ...
    def __init__(self, num_classes, dropout=0.3, point_dimension=3, device='cuda'):
